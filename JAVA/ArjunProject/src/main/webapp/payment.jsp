...
<script type="text/javascript">
	...
	function CreateOrderID()
	{
		...
		xhttp.open("GET","http://localhost:8080/ArjunProject/OrderCreation?amount="+number,false);
		alert("2");
		xhttp.send();
...
<script type="text/javascript">
	function OpenCheckOut()
	{
		...
		alert(number);
		var options={
				"key":"rzp_test_GXlEmvx1Yd5yJo",
				"amount":number,
				"currency":"INR",
				"name":"Tops",
				"description":"Test",
				"order_id":RazorpayOrderId,
				"callback_url":"http://localhost:8080/ArjunProject/OrderCreation",
				"prefill":{
					"name":"rahul sanghavi",
