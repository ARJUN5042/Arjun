								...
								<div class="col-xl-6 col-md-7 d-flex flex-column">
									<div class="card card-plain">
										<div class="card-header" style="border-radius: 20px;">
											<h4 class="font-weight-bolder" align="center">Otp Details</h4>
										</div>
										<div class="card-body">
										${notmatch }
										${Otpmatch }
										...
										{
											ServicemanModel f=(ServicemanModel)session.getAttribute("UserData");
											email=f.getEmail();
										}
										%>
											<form role="form" method="post" action="../ServicemanController">
												...
												<div
													...
													<label class="m-0 p-0" for="otp">Enter OTP : </label> <input
														type="text" class="form-control ms-3" id="otp"
														name="EnterOTP">
												</div>
												...
												<div class="text-center">
													<button type="submit"
														...
														name="action" value="verify">Verify OTP</button>
												</div>
											</form>
										</div>
