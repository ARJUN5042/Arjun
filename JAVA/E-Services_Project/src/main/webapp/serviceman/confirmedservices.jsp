...
<script>
	...
	function promptForAdditionalCharge() {
	    ...
	    if (additionalCharge !== null) 
	    {
	        ...
	        var additionalChargeInput = document.createElement("input");
	        additionalChargeInput.type = "hidden";
	        additionalChargeInput.name = "additionalCharge";
	        additionalChargeInput.value = additionalCharge;
	        form.appendChild(additionalChargeInput);
	        form.submit();
	    }
	}
</script>
                  ...
                  %>
					...
					<td class="align-middle">
    					<form method="post" action="../ServicemanController">
        					...
        					<button type="submit" class="btn-link text-secondary font-weight-bold text-xs" style="border:none; border-radius:15px; padding:0;" onclick="promptForAdditionalCharge()">
