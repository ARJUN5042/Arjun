								...
								<div class="col-xl-6 col-md-7 d-flex flex-column">
									<div class="card card-plain">
										<div class="card-header" style="border-radius: 20px;">
											<h4 class="font-weight-bolder" align="center">Change Password</h4>
										</div>
										<div class="card-body">
											
											<form role="form" method="post" action="../ServicemanController" onsubmit="return validateForm();">
												<div
													class="input-group input-group-outline mb-3 align-items-center">
													<label class="m-0 p-0" for="password">Enter Old Password : </label> 
													<input type="password" class="form-control ms-3" id="password" name="password">
													<input type="hidden" id="servicemanid" name="servicemanid" value="<%=smodel.getServicemanid() %>">
												</div>
												
												<div
													class="input-group input-group-outline mb-3 align-items-center">
													<label class="m-0 p-0" for="npassword">Enter New Password : </label> 
													<input type="password" class="form-control ms-3" id="npassword" name="npassword">
												</div>
												
												<div
													class="input-group input-group-outline mb-3 align-items-center">
													<label class="m-0 p-0" for="cnpassword">Re-Enter New Password : </label> 
													<input type="password" class="form-control ms-3" id="cnpassword" name="cnpassword">
												</div>
												...
												<div class="text-center">
													<button type="submit"
														...
														name="action" value="updatepassword">Update Password</button>
												</div>
											</form>
										</div>
									</div>
