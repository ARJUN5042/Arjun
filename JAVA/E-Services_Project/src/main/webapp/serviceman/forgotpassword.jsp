								...
								<div class="col-xl-6 col-md-7 d-flex flex-column">
									<div class="card card-plain">
										<div class="card-header" style="border-radius: 20px;">
											<h4 class="font-weight-bolder" align="center">Forgot Password Details</h4>
										</div>
										<div class="card-body">
											<form role="form" method="post" action="../ServicemanController">
												...
												<div
													...
													<label class="m-0 p-0" for="email">Enter Registerd Email : </label> <input
												...
												<div class="text-center">
													<button type="submit"
														...
														name="action" value="submit">Send OTP</button>
												</div>
											</form>
										</div>
