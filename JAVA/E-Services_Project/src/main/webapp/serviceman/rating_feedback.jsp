...
<title>View Rating & Feedback</title>
<!--     Fonts and icons     -->
					...
					<div class="card my-4">
						<div
							...
							<div
								...
								<h6 class="text-white text-capitalize ps-3">Rating &
									Feedback</h6>
							</div>
						</div>
										...
										<tr>
											...
											<div class="d-flex px-2 py-1">
												...
												<label for="feedback">Feedback:</label> 
													<textarea name="feedback" rows="3" cols="30" value="<%=rs.getString(2) %>" readonly><%=rs.getString(2) %></textarea>
													</div>
													</div>
											</td>
										</tr>
